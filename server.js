...
const allowedOrigins = (process.env.CORS_ORIGINS || 'http://localhost:5173,http://localhost:5174,https://balagh-admin.vercel.app')
  .split(',')
  .map(s => s.trim());

// ✅ Better: Dynamic CORS for development
const corsOptions = {
